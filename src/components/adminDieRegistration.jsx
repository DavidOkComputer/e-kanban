    ...
    return new Promise((resolve, reject) => { 
        ...
        img.onload = () => { 
            ...
            if (file.type === 'image/png' && file.size > 1024 * 1024) { 
                ...
                const result = tempCanvas.toDataURL('image/jpeg', outputQuality); 
    ...
    const handleImageChange = useCallback(async (e) => {       
        ...
        if (file) {       
            ...
            if (!file.type.startsWith('image/')) { 
                ...
                setMessage({ type: 'error', text: 'El archivo seleccionado no es una imagen válida' }); 
            ...
            if (file.size > 50 * 1024 * 1024) { 
                ...
                setMessage({ type: 'error', text: 'La imagen no debe superar los 50MB' }); 
            ...
            try { 
                ...
                setMessage({ type: 'error', text: 'Error al procesar la imagen. Intente con otra imagen.' }); 
        ...
        <div style={styles.container}>       
            ...
            <header style={styles.header}>       
                ...
                <div style={styles.headerRight}>       
                    ...
                    {onNavigateToUsers && user?.rol === 'admin' && ( 
                        ...
                        <button style={{ 
                            ...
                            onMouseEnter={(e) => { 
                                ...
                                e.target.style.boxShadow = '0 0 20px rgba(0, 200, 255, 0.2)'; 
                ...
                <form onSubmit={handleSubmit}>       
                        ...
                        <div style={styles.formGrid}>       
                            ...
                            {isCompressing ? ( 
                                ...
                                <div style={{ 
                                    ...
                                    <p style={{ ...styles.imageUploadText, color: '#00ff88' }}> 
                                    ...
                                    <p style={styles.imageUploadHint}> 
                                        ...
                                        Optimizando tamaño para almacenamiento 
                                ...
                                >       
                                    ...
                                    <p style={styles.imageUploadHint}>PNG, JPG, WEBP — cualquier tamaño (se comprime automáticamente)</p>       
                    ...
                    <div style={styles.buttonGroup}>       
                        ...
                        <button type="submit" style={{ 
                                ...
                                ...(isSubmitting || isCompressing ? { opacity: 0.6, cursor: 'not-allowed' } : {}), 
