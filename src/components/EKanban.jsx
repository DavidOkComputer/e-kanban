...
//tienen que estar definidos fuera del DetailModal para prevenir recreacion en cada render
...
//componente del item de historial a nivel de modal
...
const DetailModal = memo(({ item, fallas, asistenciaMotivos, onClose, onSaveAction, user }) => {    
