...
export const injectStyles = () => {
  ...
  0%,100% {
  opacity:1;
  box-shadow:0 0 8px var(--sc,#009b4a),0 0 16px var(--sc-fade,rgba(0,255,136,0.4));
}
50% {
  opacity:0.85;
  box-shadow:0 0 4px var(--sc,#009b4a),0 0 8px var(--sc-fade,rgba(0,255,136,0.2));
}
}@keyframes fadeIn {
  from {
  opacity:0;
...
export const styles = {
  ...
  priorityBadge: (priority) => ({
    ...
    height: 20,
    background:
      priority === 1 ? "#ff4466" : priority === 2 ? "#ffaa00" : "#00ff88",
    color: "#000",
    borderRadius: 4,
    fontSize: 10,
    fontWeight: 700,
    boxShadow: `0 0 8px $ {
  priority === 1 ? 'rgba(255,68,102,0.5)':priority === 2 ? 'rgba(255,170,0,0.5)':'rgba(0,255,136,0.5)'
}
`,
  }),
  priorityName: {
