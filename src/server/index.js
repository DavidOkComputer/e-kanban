...
// SEPARATE ENDPOINTS FOR BAJA TROQUEL AND ASISTENCIA 

// Both now update the die status to "Reparando" 

// ===================================================== 

 

// Endpoint for Baja de Troquel (left column) 
...
// Update the troquel status to "Reparando" 
...
// Endpoint for Asistencia en Prensa (right column) 
...
// Get the motivo description for the action_type 
...
// Get history for a troquel (updated to include folio) 
