 ...
 * Endpoint: /api/prensas.php 

 *  

 * Retorna las prensas en formato para select/dropdown: 

 * [{ "value": "P01", "label": "P01 - Prensa Hidráulica 01" }, ...] 
...
try { 
    ...
    // Obtener parámetro para filtrar solo activas (opcional) 
