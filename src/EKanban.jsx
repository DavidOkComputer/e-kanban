...
const StatusLegend = memo(() => (
  <div style={{
    ...
    <h3 style={{ fontSize: 11, fontWeight: 700, color: '#fff', marginBottom: 8, paddingBottom: 6, borderBottom: '2px solid #00ff88', margin: 0, textTransform: 'uppercase', letterSpacing: 0.5 }}>Estado</h3>
...
const EKanban = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      //info en caso de que no se conecte
      setTroqueles({
        2025: [
  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <div>
          <div style={{ width: 44, height: 44, background: 'rgba(0,255,136,0.1)', border: '2px solid rgba(0,255,136,0.4)', borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 9, color: '#00ff88', textTransform: 'uppercase', fontWeight: 600, boxShadow: '0 0 16px rgba(0,255,136,0.15)', cursor: 'pointer' }}>
            <img src="assets/Nidec Institutional Logo_White Version.jpg" alt="Logo Nidec" />
          </div>
        </div>
