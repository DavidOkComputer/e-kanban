...
// Status colors mapping (for legend and modal)
const statusColors = {
  'En prensa': '#00ff88',
  'Backup': '#00d4ff',
  'En reparación': '#ff4466',
  'Pendiente': '#ffaa00',
  'Siguiente orden': '#bf5fff',
  'Set up': '#00e5ff',
  'Por reparar': '#ffee00',
};

// Sample placeholder data for machines and dies
const sampleData = {
  2025: [
